...
export class MessagesTS {
    ...
    // Pages Errors
    public static CREATE_ERROR = 'No se pudo registrar el elemento';
    public static EDIT_ERROR = 'No se pudo editar el elemento';
    public static DELETE_ERROR = 'No se pudo eliminar el elemento';
    public static NO_FUNDS = 'Insuficientes Fondos';
    public static ADD_EXAM_ERROR = 'No se pudo añadir el examen';

    // Success Messages
    public static CREATE_SUCCESS = 'Se ha registrado correctamente el elemento';
    ...
    public static CHANGE_CC = 'La cedula fue cambiada exitosamente';
    public static ADD_PACKAGE = 'El paquete fue añadido';

    // Login and Register Messages
    public static REGISTER_SUCCESS = 'Se ha registrado el usuario correctamente';
    public static RESET_PASSWORD = 'Por favor revisa tu correo para resetear tu contraseña';
